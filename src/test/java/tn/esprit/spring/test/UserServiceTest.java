...
public class UserServiceTest {
    ...
    public void testAddUSer() throws ParseException {
        ...
        User c1 = new User("shayma","rebhi",date,"shayma.rebhi@gmail.com", "test", CategorieClient.Premuim, Profession.Etudiant);
        User c2 = new User("test2","rebhi",date,"shayma.rebhi@esprit.tn", "test", CategorieClient.Fidele, Profession.Etudiant);
        User c3 = new User("test3","rebhi",date,"shayma@gmail.com", "test", CategorieClient.Ordinaire, Profession.Etudiant);
