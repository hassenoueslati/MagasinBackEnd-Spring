...
public class UserServiceTest {
    ...
    public void testAddUSer() throws ParseException {
        ...
        User c2 = new User("test2","rebhi",date,"shayma.rebhi@esprit.tn", "test", CategorieClient.Premuim, Profession.Etudiant, Role.user);
        User c3 = new User("test3","rebhi",date,"shayma@gmail.com", "test", CategorieClient.Premuim, Profession.Etudiant,Role.user);
